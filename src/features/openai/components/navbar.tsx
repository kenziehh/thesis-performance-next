...
export function Navbar({ onSidebarMobileToggle, isSidebarMobileOpen, onSidebarDekstopToggle, isSidebarDekstopOpen }: { onSidebarMobileToggle: () => void; isSidebarMobileOpen: boolean; onSidebarDekstopToggle: () => void; isSidebarDekstopOpen: boolean }) {
    return (
